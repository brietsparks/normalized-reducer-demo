...
export const getLaneIds = (state: State) => selectors.getIds(state, { type: 'lane' });
...
export const getLane = (state: State, args: { id: Id }) => selectors.getEntity<Lane>(state, { type: 'lane', id: args.id });
